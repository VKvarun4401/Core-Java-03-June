class Iqoo
{
	public static void main(String iqo[])
	{
		...
		System.out.println("Display - iQOO Z9x comes with 6.72' large display, 120Hz 7-level adaptive refresh rate and 2408×1080 resolution. Along with 1000 nits high brightness mode(HBM) gives you clear sight even in direct sunlight. Along with it iQOO Z9x is also IP64 certified against Dust & Water.\n");
